...
func test_received_power():
	...
	assert_eq(
		result1, 3.75 * PhysicsEngine.GAME_CALCULATION_RATIO, "Baseline calculation: Got 11.25"
	)
	...
	assert_eq(
		result6, 0.75 * PhysicsEngine.GAME_CALCULATION_RATIO, "Low transmission power: Got 2.25"
	)
