...
func test_received_power():
	...
	assert_eq(result1, 3.75 * PhysicsEngine.GAME_CALCULATION_RATIO, "Baseline calculation: Got 11.25")
	...
	assert_eq(result2, 15 * PhysicsEngine.GAME_CALCULATION_RATIO, "Zero distance: Got 45.0")
	...
	assert_eq(result4, 1.875 * PhysicsEngine.GAME_CALCULATION_RATIO, "Higher frequency: Got 5.625")
	...
	assert_eq(result5, 1.875 * PhysicsEngine.GAME_CALCULATION_RATIO, "Terrain loss: Got 5.625")
	...
	assert_eq(result6, 0.75 * PhysicsEngine.GAME_CALCULATION_RATIO, "Low transmission power: Got 2.25")
