...
var jammer_bandwidth: int = 1

@export_group("Visual")
@export var unit_label: String = "J"
@export var circle_color: Color = Color("ffb347")
@export var sprite_sheet_path: String = "res://assets/sprites/jammerAni.png"
