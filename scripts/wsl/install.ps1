...
wsl -d $newDistroName bash -c "mkdir -p /mnt/c/Users/$winUsername/EMS_Game && echo 'GODOT_WIN=$wslGodotPath' > /mnt/c/Users/$winUsername/EMS_Game/.env && chmod 644 /mnt/c/Users/$winUsername/EMS_Game/.env"
